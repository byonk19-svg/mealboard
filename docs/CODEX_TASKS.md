...
use-soon suggestions, explicit pantry consumption stock apply/reversal/review UI,
...
1. **Pantry Consumption Stock Application V0, Issue 6** - lock down the full reviewed cooking-to-pantry stock path with focused regression and browser validation for confirm, explicit apply, reversal, skipped write-free behavior, empty/ineligible states, and no hidden stock mutation.
